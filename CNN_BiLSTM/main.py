...
# Load training data
training_data = Data(data_source=data_source+"train.csv",
                        alphabet=alphabet,
...
validation_data = Data(data_source=data_source+"val.csv",
                        alphabet=alphabet,
                        input_size=input_size,
                        num_of_classes=num_of_classes)
...
# Load test data
test_data = Data(data_source=data_source+"test.csv",
                    alphabet=alphabet,
                    input_size=input_size,
                    num_of_classes=num_of_classes)
test_data.load_data()
